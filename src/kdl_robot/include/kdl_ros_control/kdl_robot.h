...
public:
    ...
    KDL::JntArray getInvVelKin(const KDL::JntArray &q,
                                     const KDL::Twist &Cartesian_vel);
    
    KDL::JntArray getInvAccKin(const KDL::JntArray &q, const KDL::JntArray &dq, const KDL::Twist &Cartesian_acc);
    ...
    //getInverseKinematics is NOT implemented
